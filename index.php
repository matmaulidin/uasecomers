...
<!-- //navigation -->
	<!-- main-slider -->
		<ul id="demo1">
			<li>
				<img src="images/ikan koi 1.jpg" alt="" />
			</li>
			<li>
				<img src="images/ikan koi 5.jpg" alt="" />
			</li>
			
			<li>
				<img src="images/ikan koi 6.jpg" alt="" />
			</li>
		</ul>
	<!-- //main-slider -->
			...
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						...
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="ancahade@gmail">ancahade@gmail.com</a></li>
